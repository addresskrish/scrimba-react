...
function Main() {
    const [ingredient, setInredient] = useState(["all the main spices", "pasta", "ground beef", "tomato paste"])
    const [recipeShown, setRecipeShown] = useState(false)
    // const [input, setInput] = useState("")
    // const ingredients = ["Tomato", "Apple", "Banana"]

    const ingredientElement = ingredient.map((i) => {
        return (
            <li key={i}>{i}</li>
        )
    })
    ...
    const handleSubmit = (fromData) => {
        ...
        setInredient(prev => [...prev, newIngredient])
        // setInput("")
    }
